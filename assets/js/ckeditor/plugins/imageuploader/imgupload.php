...
//ckeditor/plugins/imageuploader//home/mohit/domains/housing.democts.biz/public_html/assets/grocery_crud/texteditor/ckeditor/plugins/imageuploader/uploads/8393fe5.jpg
$info = pathinfo($_FILES["upload"]["name"]);
$ext = $info['extension'];
$target_dir = $useruploadpath;
$ckpath = "http://".$_SERVER['HTTP_HOST'].str_replace("\\",'/',dirname($_SERVER["SCRIPT_NAME"]));
$ckpath = $ckpath.'/uploads/';
