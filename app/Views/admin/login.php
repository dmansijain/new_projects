...
<!-- Mirrored from jaybabani.com/complete-admin/v5.1/preview/ui-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Mar 2018 09:16:14 GMT -->
<head>
        <!-- 
        ...
        <link rel="apple-touch-icon-precomposed" href="<?php echo base_url(); ?>assets/admin/assets/images/apple-touch-icon-57-precomposed.png">	<!-- For iPhone -->
        <link rel="apple-touch-icon-precomposed" sizes="114x114" href="<?php echo base_url(); ?>assets/admin/assets/images/apple-touch-icon-114-precomposed.png">    <!-- For iPhone 4 Retina display -->
        <link rel="apple-touch-icon-precomposed" sizes="72x72" href="<?php echo base_url(); ?>assets/admin/assets/images/apple-touch-icon-72-precomposed.png">    <!-- For iPad -->
        <link rel="apple-touch-icon-precomposed" sizes="144x144" href="<?php echo base_url(); ?>assets/admin/assets/images/apple-touch-icon-144-precomposed.png">    <!-- For iPad Retina display -->
        ...
        <link href="<?php echo base_url(); ?>assets/admin/assets/plugins/icheck/skins/all.css" rel="stylesheet" type="text/css" media="screen"/>        <!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - END --> 
...
<div class="container-fluid">
    <div class="login-wrapper row">
        <div id="login" class="login loginpage col-lg-offset-4 col-md-offset-3 col-sm-offset-3 col-xs-offset-0 col-xs-12 col-sm-6 col-lg-4">
            ...
            <form name="loginform" id="loginform" action="http://jaybabani.com/complete-admin/v5.1/preview/index.html" method="post">
                <p>
...
<script>window.jQuery||document.write('<script src="<?php echo base_url(); ?>assets/admin/assets/js/jquery-1.11.2.min.js"><\/script>');</script>
<!-- CORE JS FRAMEWORK - END --> 


<!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - START --> 
<script src="<?php echo base_url(); ?>assets/admin/assets/plugins/icheck/icheck.min.js" type="text/javascript"></script><!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - END --> 
...
<!-- Mirrored from jaybabani.com/complete-admin/v5.1/preview/ui-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Mar 2018 09:16:15 GMT -->
</html>
