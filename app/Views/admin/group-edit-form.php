    ...
    <section class="wrapper main-wrapper row" style=''>
			<div class="row">
				...
				<div class="AddUserForm">
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><div class="pg_title"><h2 ng-show="eventinfo.id==false" >Add Group</h2><h2 ng-show="eventinfo.id > 0" >Edit Group</h2></div></div>
	  ...
	  <input type="text" name="event_typename" ng-model="eventinfo.group_name">
