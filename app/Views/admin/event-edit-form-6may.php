...
<section id="main-content" class=" ">
    <section class="wrapper main-wrapper row" style=''>
        ...
        <md-select placeholder="Event Catgeory" ng-model="eventinfo.event_category">
          ...
          <md-option ng-value="type.id" ng-repeat="type in alltype">{{type.title}}</md-option>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<md-input-container class="form-control" ng-if="!grouptype">
	  ...
	  <input type="text" name="event_typename" ng-model="eventinfo.event_typename" ng-if="grouptype">
												
												<p class="AddNew" data-toggle="modal" data-target="#addneweventtypename" ng-if="!grouptype">Add new event type name</p>
											</div>
										</div>		
										
										
									</div>
									<div class="row" ng-if="grouptype">
										<div class="col-md-12">
											<div class="form-group">
												<label>Group</label>
												<md-input-container class="form-control">
        <md-select placeholder="Group" ng-model="eventinfo.group_id">
          <md-option ng-value="group.id" ng-repeat="group in allgroups">{{group.group_name}}</md-option>
        </md-select>
      </md-input-container>
											</div>
										</div>							
