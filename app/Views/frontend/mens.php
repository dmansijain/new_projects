            ...
            <div class="row ">
                <div class="col-md-12 order-md-first order-last">
                    <header class="section-header">
                        <h1 class="border-heading text-center">MEN</h1>
                    </header>
                                    ...
                                    <div class="card-body">
                                        <div class="upcoming-event-main">
											...
											<div class="col-md-12">
												<div class="row">
													...
													<div class="col-lg-8 col-md-6 p-0 input-t-group">
													<input class="form-group Searchskill" aria-label="Searchkeyword" name="Searchkeyword" ng-model="Searchkeyword" ng-keyup="getSelectedText(selectedType)" type="text" placeholder="Search keyword" >
										...
										<div id="listview" class="tab-pane fade in active show">
                                            <div class=" d-flex justify-content-center">
												...
												<div class="table-responsive table-theme-liminal mens_table">
