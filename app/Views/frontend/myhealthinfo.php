                ...
                <div class="row justify-content-center goth">
				 <?php	echo view('frontend/profilenavigation'); ?>
                    <div class="col-md-12 d-flex justify-content-center updated-block-n p-0">
                       <form ng-submit="edithealthinfo()" name="editform" method="post"> 
					   <input type="hidden" ng-model="healthinfo.user_id">
                                                ...
                                                <div class="row align-items-baseline">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" ng-model="healthinfo.full_name" class="form-control" readonly="readonly"/>
                                                ...
                                                <div class="row align-items-baseline">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="tel" ng-model="healthinfo.address_1" class="form-control" readonly="readonly"/>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" ng-model="healthinfo.address_2" class="form-control" readonly="readonly"/>
                                                ...
                                                <div class="row align-items-baseline">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" ng-model="healthinfo.city" class="form-control" readonly="readonly"/>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" ng-model="healthinfo.state" class="form-control" readonly="readonly"/>
                                                ...
                                                <div class="row align-items-baseline">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" ng-model="healthinfo.zipcode" class="form-control" readonly="readonly"/>
								...
								<p style="color:red;" ng-if="error_message">{{error_message}}</p>
								<div class="alert alert-sucess" ng-if="message"><strong>Success!</strong> {{message}}</div>
								</div>
                                                <div class="row justify-content-center">
												
                                                    <ul class="pager wizard">
                                                        
                                                        <li class="next text-center"><button type="submit" class="btn primary-btn">Save</button></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </form>
